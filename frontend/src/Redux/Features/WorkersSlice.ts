...
>("worker/register", async (formData, { rejectWithValue }) => {
  try {
...
export const verifyEmail = createAsyncThunk<
  ...
  { rejectValue: string } // error type
>("worker/verifyEmail", async ({ user_id, otp_code }, { rejectWithValue }) => {
  try {
...
export const resendOTP = createAsyncThunk<
  ...
  { rejectValue: string } // error type
>("worker/resendOTP", async ({ user_id, email }, { rejectWithValue }) => {
  try {
