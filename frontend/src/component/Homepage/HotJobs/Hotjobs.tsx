...
const HotJobs = () => {
  ...
  useEffect(() => {
    setCurrentPage(1);
  }, [searchFilters.search_query, searchFilters.location, searchFilters.category, searchFilters.job_type]);
  ...
  return (
    <div id="jobs-section" className="mx-auto px-6 md:px-12 py-12 bg-gradient-to-b from-gray-50 to-white container">
          ...
          {hasActiveFilters ? (
            <>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-6 text-left">
                ...
                <ul className="space-y-2 text-blue-800 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span>Try searching for broader job categories (e.g., "Agriculture" instead of "Farming")</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span>Check the category dropdown to see available job categories</span>
                  </li>
                </ul>
              </div>
            ...
            <>
              ...
              <p className="text-gray-600 text-lg">
                There are currently no approved jobs. Check back soon for new opportunities!
              </p>
            </>
          )}
        </div>
