    ...
    <div className="mx-auto px-6 md:px-12 py-12 bg-gradient-to-b from-amber-50 to-white container">
      ...
      <div className="mb-12 text-center">
        ...
        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
          Hand-picked premium opportunities from top employers. These exclusive
          positions offer exceptional benefits and career growth potential.
        </p>
      ...
      {loading ? (
        ...
        <div className="text-center py-20">
          <p className="text-gray-600 text-lg">
            No featured jobs available at the moment. Check back later!
          </p>
        </div>
      ) : (
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                <div className="absolute bottom-3 right-3">
                  <div className="flex items-center gap-1 bg-white/90 text-[#800000] px-2 py-1 rounded-sm text-xs font-bold">
                    <Sparkles className="w-3 h-3" />#{index + 1}
                  </div>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <div className="flex items-center gap-2 text-xs text-gray-500">
                    ...
                    <span>
                      Premium benefits • Fast-track application • Priority
                      review
                    </span>
                  </div>
                </div>
