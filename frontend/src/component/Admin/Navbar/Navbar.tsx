...
import { closeSidebar, openSidebar } from "@/Redux/Features/AdminSIdebarSlice";
...
const Navbar = () => {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-30 h-12 bg-white border-b border-gray-200 shadow-sm px-4 flex items-center justify-between">
        {/* Left Section */}
