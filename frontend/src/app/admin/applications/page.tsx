...
const AdminApplicationsPage = () => {
 ...
 const fetchApplications = async () => {
   try {
     ...
     setApplications(response.applications as unknown as JobApplicationWithDetails[]);
   } catch (err: any) {
 ...
 const handleStatusChange = async (id: string, status: 'accepted' | 'rejected', notes?: string) => {
   try {
   ...
   return (
     <div className="p-6 max-w-7xl mx-auto space-y-4 animate-pulse">
       ...
       <div className="grid grid-cols-1 gap-6">
         {[...Array(3)].map((_, i) => <div key={i} className="h-48 bg-gray-200 rounded-lg"></div>)}
       </div>
     </div>
   );
 }
   ...
   <div className="p-6 max-w-7xl mx-auto">
     ...
     <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
       <div className="bg-white rounded-lg shadow-sm border p-6 flex items-center">
         <div className="flex-shrink-0"><Clock className="h-8 w-8 text-yellow-600" /></div>
         <div className="ml-3">
           ...
           >
             ...
             <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
               ...
               <div className="lg:col-span-2 space-y-6">
                 ...
                 {(selectedApplication.worker_notes || selectedApplication.employer_notes) && (
                   <div>
                     <h4 className="font-semibold text-gray-900 mb-3">
                        {selectedApplication.employer_notes ? 'Rejection Reason / Notes' : 'Additional Notes'}
                     </h4>
                     <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-100">
                       <p className="text-gray-800 leading-relaxed">
                         {selectedApplication.employer_notes || selectedApplication.worker_notes}
                       </p>
                     </div>
                   </div>
                 )}
     ...
     <AnimatePresence>
       {rejectingId && (
         ...
         >
           ...
           >
             <h3 className="text-lg font-bold text-red-600 mb-2">Reject Application</h3>
             <p className="text-gray-600 mb-4 text-sm">
               Please provide a reason for rejection (optional but recommended). This will be sent to the applicant.
             </p>
             ...
             <div className="flex justify-end gap-3">
               ...
               <button 
                 onClick={() => handleStatusChange(rejectingId, 'rejected', rejectionReason)}
