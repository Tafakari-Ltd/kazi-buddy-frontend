          ...
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">
                Review and approve or reject jobs that are awaiting admin
                approval
              </p>
            </div>
          </div>
          ...
          {loadingJobs ? (
            ...
            <div className="p-8 bg-white rounded-lg border border-gray-200 text-center">
              <p className="text-gray-600 mb-2">
                No jobs are currently awaiting admin approval.
              </p>
              <p className="text-sm text-gray-500">
                Once employers submit jobs that require approval, they will
                appear here.
              </p>
            </div>
          ) : (
                    ...
                    <div className="lg:col-span-2 space-y-6">
                      ...
                      <div>
                        ...
                        <div className="bg-gray-50 p-4 rounded-lg flex flex-col gap-1 text-sm text-gray-700">
                          ...
                          <span>
                            {selectedJob.employer?.user?.full_name} ·{" "}
